...
const main = () => {
  ...
  // BAKED SHADOW 1 EXAMPLE
  // const bakedShadow = textureLoader.load('/threejs/shadows/bakedShadow.jpg')
  // BAKED SHADOW 2 EXAMPLE
  const simpleShadow = textureLoader.load('/threejs/shadows/simpleShadow.jpg')
